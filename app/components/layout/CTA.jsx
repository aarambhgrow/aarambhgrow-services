...
export default function CTASection() {
  const highlights = ["No-obligation funding consultation", "Tailored funding strategy", "Confidential business information"];
  ...
  return (
    <MotionConfig reducedMotion="user">
      ...
      >
        ...
        {/* Main Container — Same Width as Previous Sections */}
          ...
          >
            ...
            <div className="relative grid grid-cols-1 items-center gap-6 p-5 sm:gap-8 sm:p-7 lg:grid-cols-12 lg:gap-10 lg:p-9">
              ...
              >
                ...
                {/* Heading */}
                <h2 id="cta-title" className="text-2xl font-black leading-[1.1] tracking-tight text-[#0f2a4a] sm:text-3xl lg:text-4xl">
                  Ready to Find the Right <span className="text-[#f26522]">Funding Opportunity?</span>
                </h2>

                {/* Description */}
                <p className="mx-auto mt-3 max-w-xl text-xs font-normal leading-[1.7] text-slate-600 sm:mt-4 sm:text-sm lg:mx-0">
                  Whether you are a startup, MSME or growing business, our experts help you understand suitable government schemes, grants,
                  startup funding, business loans and credit options based on your business and funding requirements.
                </p>
                ...
                <div className="mt-4 flex flex-wrap items-center justify-center gap-x-4 gap-y-2 sm:mt-5 sm:gap-x-5 lg:justify-start">
                  {highlights.map((item) => (
                    <div key={item} className="flex items-center gap-1.5">
                      ...
                      <span className="text-[10px] font-bold text-[#0f2a4a] sm:text-[11px]">{item}</span>
                    </div>
                  ))}
                </div>
              </motion.div>
              ...
              >
                <div className="rounded-md border border-slate-200/80 bg-[#f8fafc] p-4 sm:p-5">
                  ...
                  {/* Secondary CTA */}
                  <motion.div whileHover={{ y: -2 }} whileTap={{ scale: 0.98 }} className="mt-2">
                    <a
                  ...
                  <p className="mt-3 text-center text-[9px] font-semibold leading-relaxed text-slate-400 sm:text-[10px]">
                    Discuss startup funding, government schemes, grants, MSME loans and business finance options.
                  </p>
                </div>
              </motion.div>
            </div>
