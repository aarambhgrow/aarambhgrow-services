...
export default function SISFS() {
  const services = Array.isArray(sisfsData?.services) ? sisfsData.services : [];
  const categories = Array.isArray(sisfsData?.categories) ? sisfsData.categories : [];
  const standaloneServiceIds = ["startup-india-seed-fund-scheme", "sisfs"];
  const standaloneServiceNames = ["SISFS", "Startup India Seed Fund Scheme", "Startup India Seed Fund Scheme (SISFS)", "SISFS Funding"];
  const allowedCategoryTitles = ["Government Funding", "Startup Funding", "Investment Support", "Government Finance", "Startup Finance"];
  ...
  if (!sisfsData || services.length === 0 || !currentService)
    return (
      <section className="w-full bg-[#F8FAFC] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-md border border-red-200 bg-red-50 p-6">
            <h2 className="text-lg font-bold text-red-700">SISFS data not found</h2>
            <p className="mt-2 text-sm text-red-600">
              Please check your <strong>data/sisfs.js</strong> file and make sure the services array contains the SISFS service.
            </p>
          </div>
        </div>
      </section>
  ...
  const handleServiceClick = (serviceIndex, categoryTitle = "") => {
    ...
    if (typeof window !== "undefined" && window.innerWidth < 1024)
      setTimeout(() => {
        document.getElementById("sisfs-content")?.scrollIntoView({ behavior: "smooth", block: "start" });
      }, 100);
  };
  ...
  return (
    <section id="sisfs" className="relative w-full bg-[#F8FAFC] text-[#03254C] font-sans py-10 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          ...
          >
            {sisfsData.hero?.title || "Startup India Seed Fund Scheme (SISFS)"}
          </motion.h1>
        ...
        >
          <motion.div variants={fadeUp}>
            ...
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              The Startup India Seed Fund Scheme (SISFS) is designed to support eligible early-stage startups during important stages such
              as proof of concept, prototype development, product trials, market entry and commercialisation. AarambhGrow provides
              structured SISFS funding support to help startups understand the scheme, assess readiness and prepare relevant business,
              project and funding information.
            </p>
          </motion.div>
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              SISFS Eligibility & Startup Funding Readiness
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              SISFS eligibility depends on the applicable Startup India guidelines and the startup&apos;s profile, stage, innovation,
              business model and funding requirement. Startups should review current eligibility conditions before applying. Our support
              focuses on reviewing startup readiness, organizing required information and identifying documentation gaps.
            </p>
          </motion.div>
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              SISFS Funding for Prototype & Proof of Concept
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              Early-stage startups often require capital to validate an idea, develop prototypes, test products and establish market
              viability. SISFS is focused on eligible startup requirements connected with these early development and commercialisation
              stages, subject to the scheme guidelines and evaluation process.
            </p>
          </motion.div>
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              SISFS Application & Funding Documentation Support
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              A well-prepared application should clearly communicate the startup&apos;s business model, innovation, product or technology,
              market opportunity, funding requirement and intended use of funds. AarambhGrow helps structure business information, financial
              details, project information and pitch-related material for improved application readiness.
            </p>
          </motion.div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 items-start">
          <aside className="lg:col-span-1 bg-white border border-[#E2E8F0] rounded-md p-3 sm:p-4 shadow-[0_2px_10px_rgba(15,23,42,0.03)] lg:sticky lg:top-6">
            <div className="flex items-start gap-3 p-3 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] mb-3">
              ...
              <div>
                <h3 className="text-[11px] sm:text-xs font-bold leading-[1.35] text-[#03254C]">Startup Government Funding</h3>
              </div>
            </div>
          ...
          <div id="sisfs-content" className="lg:col-span-3 scroll-mt-24">
              ...
              >
                ...
                >
                  <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                    ...
                    <h3 className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C]">
                      Why Startups Choose SISFS Support
                    </h3>
                  </div>
