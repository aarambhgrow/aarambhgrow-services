...
export default function CGTMSE() {
  const services = Array.isArray(cgtmseData?.services) ? cgtmseData.services : [];
  const categories = Array.isArray(cgtmseData?.categories) ? cgtmseData.categories : [];
  const standaloneServiceIds = ["cgtmse"];
  const standaloneServiceNames = ["CGTMSE", "CGTMSE Loan Support"];
  const allowedCategoryTitles = ["MSME Finance", "Debt Funding", "Business Finance"];
  ...
  if (!cgtmseData || services.length === 0 || !currentService) {
    return (
      <section className="w-full bg-[#F8FAFC] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-md border border-red-200 bg-red-50 p-6">
            <h2 className="text-lg font-bold text-red-700">CGTMSE data not found</h2>
            <p className="mt-2 text-sm text-red-600">
              Please check your <strong>data/cgtmse.js</strong> file and make sure the services array contains your CGTMSE service.
            </p>
          </div>
        </div>
      </section>
  ...
  const handleServiceClick = (serviceIndex, categoryTitle = "") => {
    ...
    if (typeof window !== "undefined" && window.innerWidth < 1024) {
      setTimeout(() => {
        document.getElementById("cgtmse-content")?.scrollIntoView({ behavior: "smooth", block: "start" });
      }, 100);
    }
  };
  ...
  const sectionTitleClass = "text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C]";
  const bodyTextClass = "text-[10px] sm:text-[11px] leading-[1.4] text-[#64748B]";

  return (
    <section id="cgtmse" className="relative w-full bg-[#F8FAFC] text-[#03254C] font-sans py-10 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          <motion.div variants={fadeUp} className="mb-3 sm:mb-4">
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#157327]/10 border border-[#157327]/10 text-[#157327] text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.1em]">
              <ShieldCheck className="w-3.5 h-3.5" /> {cgtmseData.category}
            </span>
          </motion.div>
          <motion.h1
            variants={fadeUp}
          ...
          >
            {cgtmseData.hero?.title || "CGTMSE Loan & Credit Guarantee Support for MSMEs"}
          </motion.h1>
        ...
        >
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              CGTMSE Loan Support for MSMEs
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              CGTMSE provides credit guarantee support to eligible lending institutions for qualifying credit facilities extended to
              eligible Micro and Small Enterprises. AarambhGrow provides structured CGTMSE loan preparation support, helping MSMEs assess
              their financing requirements, review eligibility, organize financial information, and prepare relevant documentation.
            </p>
          </motion.div>

          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Collateral-Free Credit Support for Eligible MSMEs
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              Credit guarantee support under CGTMSE can help eligible Micro and Small Enterprises access institutional credit without
              relying solely on traditional collateral arrangements, subject to applicable scheme guidelines, borrower eligibility, lender
              assessment, and sanction conditions. Our role is to help businesses prepare for the financing process.
            </p>
          </motion.div>

          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              CGTMSE Eligibility & Loan Documentation
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              CGTMSE-linked business finance involves eligibility and documentation requirements that may vary according to the borrower,
              lender, credit facility, business activity, and applicable guidelines. AarambhGrow helps organize business registration
              details, Udyam information, financial records, banking information, project details, and other relevant supporting documents.
            </p>
          </motion.div>

          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              CGTMSE Project Report & Loan Application Support
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              A clear project report and well-organized financial information can help present the business requirement to a lending
              institution. Our support covers funding assessment, project report preparation, financial documentation, loan application
              preparation, and overall application readiness.
            </p>
          </motion.div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 items-start">
          <aside className="lg:col-span-1 bg-white border border-[#E2E8F0] rounded-md p-3 sm:p-4 shadow-[0_2px_10px_rgba(15,23,42,0.03)] lg:sticky lg:top-6">
            <div className="flex items-start gap-3 p-3 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] mb-3">
              ...
              <div>
                <h3 className="text-[11px] sm:text-xs font-bold leading-[1.35] text-[#03254C]">MSME Credit & Finance Solutions</h3>
              </div>
            </div>
          ...
          <div id="cgtmse-content" className="lg:col-span-3 scroll-mt-24">
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                  ...
                  >
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className={sectionTitleClass}>Key Benefits</h3>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className={sectionTitleClass}>Best Suitable For</h3>
                    </div>
                ...
                <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                  <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                    ...
                    <h3 className={sectionTitleClass}>What Aarambh Grow Does</h3>
                  </div>
                ...
                {Array.isArray(currentService.financeAreas) && currentService.financeAreas.length > 0 && (
                  <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className={sectionTitleClass}>MSME Finance Areas</h3>
                    </div>
                    <div className="flex flex-wrap gap-2">
                ...
                {Array.isArray(currentService.loanTypes) && currentService.loanTypes.length > 0 && (
                  <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className={sectionTitleClass}>Loan & Credit Facilities</h3>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                      {currentService.loanTypes.map((item, index) => (
                        <div
                          key={`${item}-${index}`}
                          className="flex items-center gap-2 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] p-3"
                        >
                ...
                {Array.isArray(currentService.documents) && currentService.documents.length > 0 && (
                  <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className={sectionTitleClass}>Commonly Required Documents</h3>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                ...
                {Array.isArray(currentService.process) && currentService.process.length > 0 && (
                  <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className={sectionTitleClass}>Our CGTMSE Loan Preparation Process</h3>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                      {currentService.process.map((item, index) => {
                        ...
                        return (
                          <div key={`${title}-${index}`} className="rounded-md bg-[#F8FAFC] border border-[#E2E8F0] p-3.5">
                            ...
                            {desc && <p className={bodyTextClass}>{desc}</p>}
                          </div>
                        );
                      })}
                    </div>
                ...
                <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                  <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                    ...
                    <h3 className={sectionTitleClass}>Why Businesses Choose CGTMSE Loan Support</h3>
                  </div>
