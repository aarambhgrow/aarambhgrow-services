...
import { ArrowRight, MessageCircle, Rocket, FileText, BadgePercent } from "lucide-react";
import { motion } from "framer-motion";

const TRUST_POINTS = [
  {
    title: "New Enterprise",
    description: "Business setup & strategy",
    icon: Rocket,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  {
    ...
    description: "Cost planning & DPR support",
    icon: FileText,
    color: "text-[#F26522]",
    bg: "bg-[#F26522]/10",
  },
  {
    ...
    description: "Application & eligibility review",
    icon: BadgePercent,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  ...
  return (
    <section className="relative min-h-0 w-full overflow-hidden bg-[#EFFFFD] font-sans sm:min-h-[520px] lg:min-h-[460px]">
      ...
      <div className="absolute right-0 top-0 hidden h-full w-[60%] sm:block lg:w-[50%] xl:w-[45%]">
        <Image
          src="/images/PMEGP.png"
          alt="PMEGP loan and subsidy support for new enterprises"
          fill
          priority
      ...
      <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-[1340px] flex-col items-center px-5 pt-6 pb-0 sm:min-h-[500px] sm:flex-row sm:px-8 sm:py-12 lg:min-h-[460px] lg:px-12 xl:px-16">
        ...
        >
          ...
          <h1 className="max-w-[680px] text-[24px] font-extrabold leading-[1.15] tracking-[-0.025em] text-[#03254C] sm:text-[36px] lg:text-[38px]">
            Start Your New Enterprise With <span className="text-[#157327]">PMEGP Loan & Subsidy Support</span>
          </h1>
          ...
          <h2 className="mt-2.5 text-[13px] font-bold leading-tight text-[#F26522] sm:mt-3 sm:text-lg">
            Project Planning + <span className="text-[#03254C]">Finance Preparation</span>
          </h2>

          {/* Description */}
          <p className="mt-2 max-w-[620px] text-[11px] leading-[1.45] text-[#475569] sm:mt-3 sm:text-[13px] sm:leading-[1.6] lg:text-[14px]">
            Prepare your new enterprise for the PMEGP application process with structured assistance in project assessment, cost planning,
            project reports, financial information, documentation, and application readiness.
          </p>
          ...
          <div className="mt-4 flex flex-col gap-3 sm:mt-5 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            >
              ...
              <span className="relative">Plan Your PMEGP Project</span>
