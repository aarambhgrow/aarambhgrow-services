...
import { ArrowRight, MessageCircle, Store, Wallet, TrendingUp } from "lucide-react";
import { motion } from "framer-motion";

const TRUST_POINTS = [
  {
    title: "Micro Business",
    description: "Tailored micro-funding paths",
    icon: Store,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  {
    ...
    description: "Manage operational cash flow",
    icon: Wallet,
    color: "text-[#F26522]",
    bg: "bg-[#F26522]/10",
  },
  {
    ...
    description: "Scale equipment & capacity",
    icon: TrendingUp,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
    ...
    <section className="relative min-h-0 w-full overflow-hidden bg-[#EFFFFD] font-sans sm:min-h-[520px] lg:min-h-[460px]">
      ...
      <div className="absolute right-0 top-0 hidden h-full w-[60%] sm:block lg:w-[50%] xl:w-[45%]">
        <Image
          ...
          alt="Mudra Loan support for micro businesses and entrepreneurs"
          fill
          priority
      ...
      <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-[1340px] flex-col items-center px-5 pt-6 pb-0 sm:min-h-[500px] sm:flex-row sm:px-8 sm:py-12 lg:min-h-[460px] lg:px-12 xl:px-16">
        ...
        >
          ...
          <h1 className="max-w-[680px] text-[24px] font-extrabold leading-[1.15] tracking-[-0.025em] text-[#03254C] sm:text-[36px] lg:text-[38px]">
            Finance Your Next Business Step With{" "}
            <span className="text-[#157327]">Mudra Loan Support</span>
          </h1>
          ...
          <h2 className="mt-2.5 text-[13px] font-bold leading-tight text-[#F26522] sm:mt-3 sm:text-lg">
            For Micro Businesses & <span className="text-[#03254C]">Entrepreneurs</span>
          </h2>

          {/* Description */}
          <p className="mt-2 max-w-[620px] text-[11px] leading-[1.45] text-[#475569] sm:mt-3 sm:text-[13px] sm:leading-[1.6] lg:text-[14px]">
            Get structured support for Mudra Loan preparation, including business finance assessment, project planning, documentation, working capital requirements, and loan application readiness.
          </p>
          ...
          <div className="mt-4 flex flex-col gap-3 sm:mt-5 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            >
              ...
              <span className="relative">Explore Mudra Finance</span>
