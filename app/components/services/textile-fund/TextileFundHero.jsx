...
import { ArrowRight, MessageCircle, Factory, Cpu, Layers } from "lucide-react";
import { motion } from "framer-motion";

const TRUST_POINTS = [
  {
    title: "Textile Modernization",
    description: "Technology & machinery upgrade",
    icon: Factory,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  {
    title: "Capital Subsidy Aid",
    description: "Incentive & grant compliance",
    icon: Cpu,
    color: "text-[#F26522]",
    bg: "bg-[#F26522]/10",
  },
  {
    ...
    description: "DPR & credit facility support",
    icon: Layers,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
...
export default function TextileFund() {
  return (
    <section className="relative min-h-0 w-full overflow-hidden bg-[#EFFFFD] font-sans sm:min-h-[520px] lg:min-h-[460px]">
      ...
      <div className="absolute right-4 lg:right-18 top-[55%] hidden -translate-y-1/2 items-center justify-end sm:flex sm:w-[48%] lg:w-[42%] xl:w-[38%] h-[85%] pt-4">
        <Image
          src="/images/textilefund.png"
          alt="Textile Fund and Funding Opportunities for Startups"
          fill
          priority
      ...
      <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-[1340px] flex-col items-center px-5 pt-6 pb-0 sm:min-h-[500px] sm:flex-row sm:px-8 sm:py-12 lg:min-h-[460px] lg:px-12 xl:px-16">
        ...
        >
          ...
          <h2 className="mt-2.5 text-[13px] font-bold leading-tight text-[#F26522] sm:mt-3 sm:text-lg">
            Technology Upgradation & <span className="text-[#03254C]">Expansion Schemes</span>
          </h2>

          {/* Description */}
          <p className="mt-2 max-w-[620px] text-[11px] leading-[1.45] text-[#475569] sm:mt-3 sm:text-[13px] sm:leading-[1.6] lg:text-[14px]">
            Get expert guidance on textile funding schemes, capital subsidies, technology upgradation assistance, project report
            preparation, and financial readiness for textile enterprises.
          </p>
          ...
          <div className="mt-4 flex flex-col gap-3 sm:mt-5 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            >
              ...
              <span className="relative">Explore Textile Funding</span>
            ...
            >
              <span>Discuss Project Funding</span>
