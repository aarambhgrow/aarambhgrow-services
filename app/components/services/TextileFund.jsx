...
import { CheckCircle2, ShieldCheck, Target, FileText, Award, ChevronDown, WalletCards, IndianRupee, Factory, Layers3 } from "lucide-react";

import { textileFundData } from "../../data/textile-fund";

export default function TextileFund() {
  const services = Array.isArray(textileFundData?.services) ? textileFundData.services : [];

  const categories = Array.isArray(textileFundData?.categories) ? textileFundData.categories : [];

  const standaloneServiceIds = ["textile-fund"];

  const standaloneServiceNames = ["Textile Fund", "Textile Funding", "Textile Fund Support", "Textile Industry Funding"];
  ...
  if (!textileFundData || services.length === 0 || !currentService) {
    return (
      <section className="w-full bg-[#F8FAFC] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-md border border-red-200 bg-red-50 p-6">
            <h2 className="text-lg font-bold text-red-700">Textile Fund data not found</h2>

            <p className="mt-2 text-sm text-red-600">
              Please check your <strong>data/textile-fund.js</strong> file and make sure the services array contains the Textile Fund
              service.
            </p>
          </div>
        </div>
  ...
  const handleServiceClick = (serviceIndex, categoryTitle = "") => {
    ...
    if (typeof window !== "undefined" && window.innerWidth < 1024) {
      setTimeout(() => {
        document.getElementById("textile-fund-content")?.scrollIntoView({
          behavior: "smooth",
          block: "start",
        });
      }, 100);
  ...
  return (
    <section id="textile-fund" className=" relative w-full bg-[#F8FAFC] text-[#03254C] font-sans py-10 sm:py-12 lg:py-16 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          ...
          >
            {textileFundData.hero?.title || "Textile Fund & Textile Industry Funding Support"}
          </motion.h1>
          ...
          >
            {textileFundData.hero?.description}
          </motion.p>
        </motion.div>
        <motion.div
          variants={containerVariants}
        ...
        >
          <motion.div variants={fadeUp}>
            <h2 className=" text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3 ">
              Textile Fund & Textile Industry Funding Support
            </h2>

            <p className=" text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569] ">
              Textile businesses may require funding for machinery, technology upgrades, manufacturing expansion, working capital,
              modernization, production capacity and other eligible business requirements. AarambhGrow provides structured textile funding
              and government scheme support for eligible textile manufacturers, processing units and allied businesses.
            </p>
          </motion.div>

          <motion.div variants={fadeUp}>
            <h2 className=" text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3 ">
              Textile Industry Loans, Subsidies & Government Schemes
            </h2>

            <p className=" text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569] ">
              Textile enterprises may explore different financing and government support opportunities depending on their business activity,
              location, investment, project size and applicable scheme conditions. These may include business loans, working capital
              finance, machinery finance, technology-upgrade support, capital assistance, subsidies and industry-specific government
              programmes.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeUp}>
            <h2 className=" text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3 ">
              Textile Machinery & Technology Upgrade Funding
            </h2>

            <p className=" text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569] ">
              Textile manufacturers often invest in modern machinery, production systems, processing equipment, quality improvement and
              technology upgrades to improve capacity and operational efficiency. AarambhGrow helps structure project costs, business
              information, financial requirements and supporting documents for suitable funding opportunities.
            </p>
          </motion.div>

          <motion.div variants={fadeUp}>
            <h2 className=" text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3 ">
              Textile Funding Application & Documentation Support
            </h2>

            <p className=" text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569] ">
              Textile funding applications may require business registration details, project reports, machinery quotations, financial
              statements, banking information, investment details and other supporting documents. Our approach focuses on application
              readiness, accurate documentation and clear presentation of the proposed textile project.
            </p>
          </motion.div>
        </motion.div>
        <div className=" grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 items-start ">
          <aside className=" lg:col-span-1 bg-white border border-[#E2E8F0] rounded-md p-3 sm:p-4 shadow-[0_2px_10px_rgba(15,23,42,0.03)] lg:sticky lg:top-6 ">
            <div className=" flex items-start gap-3 p-3 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] mb-3 ">
              <div className=" w-8 h-8 rounded-md bg-[#157327]/10 flex items-center justify-center shrink-0 ">
                <Factory className=" w-4 h-4 text-[#157327] " />
              </div>

              <div>
                <h3 className=" text-[11px] sm:text-xs font-bold leading-[1.35] text-[#03254C] ">Textile Industry Funding</h3>
              </div>
            </div>
          ...
          <div id="textile-fund-content" className=" lg:col-span-3 scroll-mt-24 ">
              ...
              >
                ...
                {Array.isArray(currentService.fundingTypes) && currentService.fundingTypes.length > 0 && (
                  ...
                  >
                    <div className=" flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0] ">
                      <div className=" w-8 h-8 rounded-md bg-[#157327]/10 flex items-center justify-center shrink-0 ">
                        <Layers3 className=" w-4 h-4 text-[#157327] " />
                      </div>

                      <h3 className=" text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C] ">
                        Textile Funding & Scheme Types
                      </h3>
                    </div>
                ...
                {Array.isArray(currentService.textileSegments) && currentService.textileSegments.length > 0 && (
                  <motion.div
                    variants={cardVariants}
                    initial="hidden"
                    animate="visible"
                  ...
                  >
                    <div className=" flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0] ">
                      <div className=" w-8 h-8 rounded-md bg-[#03254C]/10 flex items-center justify-center shrink-0 ">
                        <Factory className=" w-4 h-4 text-[#03254C] " />
                      </div>
                    ...
                    <div className=" grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5 ">
                      {currentService.textileSegments.map((item, index) => (
                        <div
                          key={`${item}-${index}`}
                          className=" flex items-start gap-2 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] p-3 "
                        >
                ...
                {Array.isArray(currentService.eligibleActivities) && currentService.eligibleActivities.length > 0 && (
                  <motion.div
                    variants={cardVariants}
                    initial="hidden"
                    animate="visible"
                  ...
                  >
                    <div className=" flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0] ">
                      <div className=" w-8 h-8 rounded-md bg-[#157327]/10 flex items-center justify-center shrink-0 ">
                        <CheckCircle2 className=" w-4 h-4 text-[#157327] " />
                      </div>
                ...
                >
                  <div className=" flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0] ">
                    ...
                    <h3 className=" text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C] ">
                      Why Businesses Choose Textile Funding Support
                    </h3>
                  </div>
