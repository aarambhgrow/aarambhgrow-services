...
export default function GovernmentGrants() {
  const services = Array.isArray(governmentGrantsData?.services) ? governmentGrantsData.services : [];
  const categories = Array.isArray(governmentGrantsData?.categories) ? governmentGrantsData.categories : [];
  const standaloneServiceIds = ["government-grants"];
  const standaloneServiceNames = ["Government Grants", "Government Grant Support", "Government Grants & Subsidies"];
  const allowedCategoryTitles = ["Grants & Subsidies", "Grant Funding", "Government Funding"];
  ...
  if (!governmentGrantsData || services.length === 0 || !currentService) {
    return (
      <section className="w-full bg-[#F8FAFC] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-md border border-red-200 bg-red-50 p-6">
            <h2 className="text-lg font-bold text-red-700">Government Grants data not found</h2>
            <p className="mt-2 text-sm text-red-600">
              Please check your <strong>data/government-grants.js</strong> file and make sure the services array contains your Government
              Grants service.
            </p>
          </div>
        </div>
  ...
  const handleServiceClick = (serviceIndex, categoryTitle = "") => {
    ...
    if (typeof window !== "undefined" && window.innerWidth < 1024) {
      setTimeout(() => {
        document.getElementById("government-grants-content")?.scrollIntoView({ behavior: "smooth", block: "start" });
      }, 100);
    }
  };
  ...
  return (
    <section id="government-grants" className="relative w-full bg-[#F8FAFC] text-[#03254C] font-sans py-10 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          ...
          >
            {governmentGrantsData.hero?.title || "Government Grants for Startups & MSMEs"}
          </motion.h1>
          ...
          >
            {governmentGrantsData.hero?.description}
          </motion.p>
        </motion.div>
        ...
        >
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Government Grants for Startups & MSMEs
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              Government grants and subsidy programmes can provide financial support to eligible startups, MSMEs, entrepreneurs,
              manufacturers, technology businesses, and businesses undertaking eligible development or expansion projects. AarambhGrow helps
              businesses identify suitable government funding opportunities and prepare the required business, project, and financial
              information.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Government Grants & Subsidies in India
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              Government funding opportunities may include central and state government grants, business subsidies, capital subsidies,
              technology incentives, innovation support, research and development assistance, and industry-specific schemes. Eligibility,
              funding structure, application requirements, and availability vary by scheme and are subject to applicable government
              guidelines.
            </p>
          </motion.div>
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Grant Eligibility & Government Scheme Assessment
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              Government grant eligibility can depend on factors such as business type, industry, location, project activity, investment,
              employment generation, technology adoption, innovation, applicant category, and scheme guidelines. AarambhGrow helps review
              business information and identify relevant eligibility considerations before application.
            </p>
          </motion.div>

          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Government Grant Application & Documentation Support
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              A well-prepared grant application should clearly explain the business, proposed project, funding requirement, financial
              information, expected outcomes, and supporting documentation. Our government grant support focuses on organizing these
              requirements and improving overall application readiness.
            </p>
          </motion.div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 items-start">
          <aside className="lg:col-span-1 bg-white border border-[#E2E8F0] rounded-md p-3 sm:p-4 shadow-[0_2px_10px_rgba(15,23,42,0.03)] lg:sticky lg:top-6">
            <div className="flex items-start gap-3 p-3 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] mb-3">
              ...
              <div>
                <h3 className="text-[11px] sm:text-xs font-bold leading-[1.35] text-[#03254C]">Government Funding & Grant Solutions</h3>
              </div>
            </div>
          ...
          <div id="government-grants-content" className="lg:col-span-3 scroll-mt-24">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {Array.isArray(currentService.grantAreas) && currentService.grantAreas.length > 0 && (
                  <motion.div
                    variants={cardVariants}
                    initial="hidden"
                    animate="visible"
                  ...
                  >
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C]">
                        Government Grant Areas
                      </h3>
                    </div>

                    <div className="flex flex-wrap gap-2">
                      {currentService.grantAreas.map((item, index) => (
                        <span
                          key={`${item}-${index}`}
                ...
                {Array.isArray(currentService.grantTypes) && currentService.grantTypes.length > 0 && (
                  <motion.div
                    variants={cardVariants}
                    initial="hidden"
                    animate="visible"
                  ...
                  >
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                      {currentService.grantTypes.map((item, index) => (
                        <div
                          key={`${item}-${index}`}
                ...
                {Array.isArray(currentService.suitedIndustries) && currentService.suitedIndustries.length > 0 && (
                  <motion.div
                    variants={cardVariants}
                    initial="hidden"
                    animate="visible"
                  ...
                  >
                    ...
                    <div className="flex flex-wrap gap-2">
                      {currentService.suitedIndustries.map((item, index) => (
                        <span
                          key={`${item}-${index}`}
                          className="px-2.5 py-1.5 rounded-md bg-[#157327]/5 border border-[#157327]/15 text-[10px] sm:text-[11px] font-semibold text-[#157327]"
                        >
                ...
                >
                  <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                    ...
                    <h3 className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C]">
                      Why Businesses Choose Government Grant Support
                    </h3>
                  </div>
