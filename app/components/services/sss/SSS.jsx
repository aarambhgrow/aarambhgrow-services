...
import { CheckCircle2, ShieldCheck, Target, FileText, Award, ChevronDown, Landmark } from "lucide-react";

import sssData from "../../../data/sss";

export default function SSS() {
  const services = Array.isArray(sssData?.services) ? sssData.services : [];

  const categories = Array.isArray(sssData?.categories) ? sssData.categories : [];

  const standaloneServiceIds = [];
  ...
  const allowedCategoryTitles = ["Scheme Support"];
  ...
  if (!sssData || services.length === 0 || !currentService) {
    return (
      <section className="w-full bg-[#F8FAFC] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-md border border-red-200 bg-red-50 p-6">
            <h2 className="text-lg font-bold text-red-700">SSS data not found</h2>

            <p className="mt-2 text-sm text-red-600">
              Please check your <strong>data/sss.js</strong> file and make sure the <strong>services</strong> array contains your SSS
              services.
            </p>
          </div>
        </div>
  ...
  const handleServiceClick = (serviceIndex, categoryTitle = "") => {
    ...
    if (typeof window !== "undefined" && window.innerWidth < 1024) {
      setTimeout(() => {
        document.getElementById("sss-content")?.scrollIntoView({
          behavior: "smooth",
          block: "start",
        });
      }, 100);
  ...
  return (
    <section id="sss" className=" relative w-full bg-[#F8FAFC] text-[#03254C] font-sans py-10 sm:py-12 lg:py-16 ">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* =====================================================
                    INTRO
                ===================================================== */}
        ...
        >
          ...
          >
            {sssData.hero?.title || "SSS Scheme Support"}
          </motion.h1>
        ...
        <div className="max-w-4xl mb-10 sm:mb-12 space-y-8">
          <div>
            <h2 className=" text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3 ">
              SSS Scheme Support for Businesses
            </h2>

            <p className=" text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569] ">
              SSS scheme support helps eligible businesses and entrepreneurs understand applicable scheme requirements, funding
              opportunities, documentation, and application procedures. AarambhGrow provides structured assistance to help businesses
              prepare their information and supporting documents for suitable scheme opportunities.
            </p>
          </div>
          ...
          <div>
            ...
            <p className=" text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569] ">
              Government and institutional schemes generally have specific eligibility criteria based on the applicant, business activity,
              investment, location, project type, and other applicable conditions. AarambhGrow helps review available information and
              identify important eligibility and documentation requirements before application.
            </p>
          </div>

          <div>
            <h2 className=" text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3 ">
              Scheme Application & Documentation Support
            </h2>

            <p className=" text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569] ">
              Proper documentation is an important part of scheme applications. AarambhGrow assists with organizing business information,
              financial documents, project details, KYC records, and other supporting documents required for the applicable scheme and
              application process.
            </p>
          </div>
          ...
          <div>
            <h2 className=" text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3 ">
              Business Funding & Scheme Assistance
            </h2>

            <p className=" text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569] ">
              Suitable government schemes can provide different forms of support depending on the applicable guidelines. Our structured
              approach helps businesses understand their funding requirement, prepare relevant information, and improve application
              readiness before approaching the concerned authority, institution, or lender.
            </p>
          </div>
        </div>
        ...
        <div className=" grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 items-start ">
          ...
          <aside className=" lg:col-span-1 bg-white border border-[#E2E8F0] rounded-md p-3 sm:p-4 shadow-[0_2px_10px_rgba(15,23,42,0.03)] lg:sticky lg:top-6 ">
            ...
            <div className=" flex items-start gap-3 p-3 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] mb-3 ">
              <div className=" w-8 h-8 rounded-md bg-[#03254C]/10 flex items-center justify-center shrink-0 ">
                <Landmark className=" w-4 h-4 text-[#03254C] " />
              </div>

              <div>
                <h3 className=" text-[11px] sm:text-xs font-bold leading-[1.35] text-[#03254C] ">Scheme Support for Business Growth</h3>
              </div>
            </div>
          ...
          <div id="sss-content" className=" lg:col-span-3 scroll-mt-24 ">
