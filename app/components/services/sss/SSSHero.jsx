...
import { ArrowRight, MessageCircle, CheckCircle2, PieChart, Presentation } from "lucide-react";
import { motion } from "framer-motion";

const TRUST_POINTS = [
  {
    title: "Investor Readiness",
    description: "Financials & valuation strategy",
    icon: CheckCircle2,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  {
    ...
    description: "Funding roadmap & requirement",
    icon: PieChart,
    color: "text-[#F26522]",
    bg: "bg-[#F26522]/10",
  },
  {
    ...
    description: "Pitch decks & investor materials",
    icon: Presentation,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  ...
  return (
    <section className="relative min-h-0 w-full overflow-hidden bg-[#EFFFFD] font-sans sm:min-h-[520px] lg:min-h-[460px]">
      ...
      <div className="absolute right-0 top-0 hidden h-full w-[60%] sm:block lg:w-[50%] xl:w-[45%]">
        <Image
          src="/images/SSS.png"
          alt="Seed Funding Access for Startups"
          fill
          priority
