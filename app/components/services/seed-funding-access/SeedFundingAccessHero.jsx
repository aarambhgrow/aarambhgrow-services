...
import { ArrowRight, MessageCircle, ShieldCheck, Target, Presentation } from "lucide-react";
import { motion } from "framer-motion";

const TRUST_POINTS = [
  {
    title: "Investor Readiness",
    description: "Structure key requirements",
    icon: ShieldCheck,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  {
    title: "Seed Capital Strategy",
    description: "Align funding roadmaps",
    icon: Target,
    color: "text-[#F26522]",
    bg: "bg-[#F26522]/10",
  },
  {
    ...
    description: "Refine decks & documentation",
    icon: Presentation,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
...
export default function SeedFundingAccess() {
  return (
    <section className="relative min-h-0 w-full overflow-hidden bg-[#EFFFFD] font-sans sm:min-h-[520px] lg:min-h-[460px]">
      {/* Background Image Container (Desktop/Tablet) — Increased width for web view */}
      <div className="absolute right-0 top-0 hidden h-full w-[60%] sm:block lg:w-[50%] xl:w-[45%]">
        <Image
          src="/images/seed-funding-access.png"
          alt="Seed Funding Access and Investor Readiness Support"
          fill
          priority
        ...
        >
          ...
          <div className="mt-4 flex flex-col gap-3 sm:mt-5 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            >
              ...
              <span className="relative">Prepare for Fundraising</span>
