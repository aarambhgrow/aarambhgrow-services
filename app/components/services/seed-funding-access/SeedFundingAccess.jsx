...
import { CheckCircle2, ShieldCheck, Target, FileText, Award, ChevronDown, WalletCards, IndianRupee, Users, TrendingUp } from "lucide-react";
import { seedFundingAccessData } from "../../../data/seed-funding-access";

export default function SeedFundingAccess() {
  const services = Array.isArray(seedFundingAccessData?.services) ? seedFundingAccessData.services : [];
  const categories = Array.isArray(seedFundingAccessData?.categories) ? seedFundingAccessData.categories : [];
  const standaloneServiceIds = ["seed-funding-access"];
  const standaloneServiceNames = ["Seed Funding Access", "Seed Funding", "Startup Funding", "Startup Investment"];
  const allowedCategoryTitles = ["Investment Support", "Startup Funding", "Equity", "Business Finance", "Startup Finance"];
  ...
  if (!seedFundingAccessData || services.length === 0 || !currentService) {
    return (
      <section className="w-full bg-[#F8FAFC] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-md border border-red-200 bg-red-50 p-6">
            <h2 className="text-lg font-bold text-red-700">Seed Funding data not found</h2>
            <p className="mt-2 text-sm text-red-600">
              Please check your <strong>data/seed-funding-access.js</strong> file and make sure the services array contains the Seed Funding
              Access service.
            </p>
          </div>
        </div>
  ...
  const handleServiceClick = (serviceIndex, categoryTitle = "") => {
    ...
    if (typeof window !== "undefined" && window.innerWidth < 1024) {
      setTimeout(() => {
        document.getElementById("seed-funding-access-content")?.scrollIntoView({ behavior: "smooth", block: "start" });
      }, 100);
    }
  };
  ...
  return (
    <section id="seed-funding-access" className="relative w-full bg-[#F8FAFC] text-[#03254C] font-sans py-10 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          <motion.div variants={fadeUp} className="mb-3 sm:mb-4">
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#157327]/10 border border-[#157327]/10 text-[#157327] text-[10px] sm:text-[11px] font-semibold uppercase tracking-[0.1em]">
              ...
              {seedFundingAccessData.category}
            </span>
          </motion.div>
          <motion.h1
            variants={fadeUp}
          ...
          >
            {seedFundingAccessData.hero?.title || "Seed Funding Access for Startups"}
          </motion.h1>
          ...
          >
            {seedFundingAccessData.hero?.description}
          </motion.p>
        </motion.div>
        ...
        >
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Seed Funding Access for Startups in India
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              Seed funding can provide important capital for early-stage startups developing products, validating business ideas, building
              teams, entering markets and preparing for growth. AarambhGrow provides structured seed funding support to help founders
          ...
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Seed Capital & Startup Investment Opportunities
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              Startups may explore different sources of early-stage capital depending on their business model, stage, market opportunity,
              traction, funding requirement and investor fit. These can include seed investors, angel investors, venture capital funds,
              incubators, accelerators and other startup investment networks. Investment decisions remain subject to investor evaluation and
              applicable terms.
            </p>
          </motion.div>
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Investor Readiness & Startup Pitch Preparation
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              Investor readiness involves clearly presenting the startup&apos;s problem, solution, market, business model, traction,
              competitive advantage, financial requirements and growth strategy. AarambhGrow helps organize business information, funding
              documentation and pitch content so founders can approach relevant funding opportunities with greater clarity.
            </p>
          </motion.div>
          <motion.div variants={fadeUp}>
            <h2 className="text-[20px] sm:text-[24px] lg:text-[28px] font-extrabold tracking-[-0.02em] leading-[1.2] text-[#03254C] mb-3">
              Startup Fundraising & Funding Documentation
            </h2>
            <p className="text-[12px] sm:text-[13px] lg:text-[14px] leading-[1.75] text-[#475569]">
              A strong fundraising process requires relevant business, financial and investment information. Depending on the funding
              opportunity, founders may need business plans, financial projections, pitch presentations, company information, product
              details, market analysis and supporting documents. Our support focuses on improving funding readiness and preparing
              information for potential investor discussions.
            </p>
          </motion.div>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 items-start">
          <aside className="lg:col-span-1 bg-white border border-[#E2E8F0] rounded-md p-3 sm:p-4 shadow-[0_2px_10px_rgba(15,23,42,0.03)] lg:sticky lg:top-6">
            <div className="flex items-start gap-3 p-3 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] mb-3">
              <div className="w-8 h-8 rounded-md bg-[#157327]/10 flex items-center justify-center shrink-0">
                <TrendingUp className="w-4 h-4 text-[#157327]" />
              </div>
              <div>
                <h3 className="text-[11px] sm:text-xs font-bold leading-[1.35] text-[#03254C]">Startup Investment Support</h3>
              </div>
            </div>
          ...
          <div id="seed-funding-access-content" className="lg:col-span-3 scroll-mt-24">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                {Array.isArray(currentService.investmentSources) && currentService.investmentSources.length > 0 && (
                  <motion.div
                    variants={cardVariants}
                    initial="hidden"
                    animate="visible"
                  ...
                  >
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      <div className="w-8 h-8 rounded-md bg-[#03254C]/10 flex items-center justify-center shrink-0">
                        <Users className="w-4 h-4 text-[#03254C]" />
                      </div>
                      <h3 className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                      {currentService.investmentSources.map((item, index) => (
                        <div
                          key={`${item}-${index}`}
                ...
                >
                  <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                    ...
                    <h3 className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C]">
                      Why Businesses Choose Seed Funding Support
                    </h3>
                  </div>
