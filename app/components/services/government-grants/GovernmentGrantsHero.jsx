...
import { ArrowRight, MessageCircle, Search, ShieldCheck, FileCheck } from "lucide-react";
import { motion } from "framer-motion";

const TRUST_POINTS = [
  {
    title: "Scheme Identification",
    description: "Find relevant grants & subsidies",
    icon: Search,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  {
    ...
    description: "Verify profile & activity fit",
    icon: ShieldCheck,
    color: "text-[#F26522]",
    bg: "bg-[#F26522]/10",
  },
  ...
  return (
    <section className="relative min-h-0 w-full overflow-hidden bg-[#EFFFFD] font-sans sm:min-h-[520px] lg:min-h-[460px]">
      ...
      <div className="absolute right-0 top-0 hidden h-full w-[60%] sm:block lg:w-[50%] xl:w-[45%]">
        <Image
          src="/images/government-grants.png"
          alt="Government grants, subsidies and business support opportunities"
          fill
          priority
      ...
      <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-[1340px] flex-col items-center px-5 pt-6 pb-0 sm:min-h-[500px] sm:flex-row sm:px-8 sm:py-12 lg:min-h-[460px] lg:px-12 xl:px-16">
        ...
        >
          ...
          <h1 className="max-w-[680px] text-[24px] font-extrabold leading-[1.15] tracking-[-0.025em] text-[#03254C] sm:text-[36px] lg:text-[38px]">
            Discover Government Grant Opportunities for{" "}
            <span className="text-[#157327]">Your Business</span>
          </h1>
          ...
          <h2 className="mt-2.5 text-[13px] font-bold leading-tight text-[#F26522] sm:mt-3 sm:text-lg">
            Grants, Subsidies & <span className="text-[#03254C]">Business Support</span>
          </h2>

          {/* Description */}
          <p className="mt-2 max-w-[620px] text-[11px] leading-[1.45] text-[#475569] sm:mt-3 sm:text-[13px] sm:leading-[1.6] lg:text-[14px]">
            Identify relevant government grants, subsidies, incentives, and business support opportunities based on your business activity, project requirements, sector, and eligibility profile.
          </p>
          ...
          <div className="mt-4 flex flex-col gap-3 sm:mt-5 sm:flex-row sm:flex-wrap sm:items-center">
            {/* Primary CTA */}
            <Link
              href="#government-grants-content"
            ...
            >
              ...
              <span className="relative">Explore Grant Opportunities</span>
