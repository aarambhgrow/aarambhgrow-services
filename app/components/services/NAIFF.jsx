...
export default function NAIFF() {
  const services = Array.isArray(naiffData?.services) ? naiffData.services : [];
  const categories = Array.isArray(naiffData?.categories) ? naiffData.categories : [];
  const standaloneServiceIds = ["naiff"];
  ...
  const allowedCategoryTitles = [
    "Agri Finance",
    "Agriculture Finance",
    "Agriculture Infrastructure Finance",
    "Business Finance",
    "Government Finance",
  ];
  ...
  if (!naiffData || services.length === 0 || !currentService) {
    return (
      <section className="w-full bg-[#F8FAFC] py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="rounded-md border border-red-200 bg-red-50 p-6">
            <h2 className="text-lg font-bold text-red-700">NAIFF data not found</h2>
            <p className="mt-2 text-sm text-red-600">
              Please check your <strong>data/naiff.js</strong> file and make sure the services array contains your NAIFF service.
            </p>
          </div>
        </div>
      </section>
  ...
  const handleServiceClick = (serviceIndex, categoryTitle = "") => {
    ...
    if (typeof window !== "undefined" && window.innerWidth < 1024) {
      setTimeout(() => document.getElementById("naiff-content")?.scrollIntoView({ behavior: "smooth", block: "start" }), 100);
    }
  };
  ...
  const cardClass = "bg-white border border-[#E2E8F0] rounded-md p-5 sm:p-6 shadow-[0_2px_10px_rgba(15,23,42,0.025)]";
  const headingClass = "text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.1em] text-[#03254C]";
  const iconBoxClass = "w-8 h-8 rounded-md flex items-center justify-center shrink-0";

  return (
    <section id="naiff" className="relative w-full bg-[#F8FAFC] text-[#03254C] font-sans py-10 sm:py-12 lg:py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          ...
          >
            {naiffData.hero?.title || "NAIFF / Agriculture Infrastructure Fund"}
          </motion.h1>
        ...
        >
          {[
            [
              "NAIFF / Agriculture Infrastructure Fund",
              "NAIFF, commonly used in reference to the Agriculture Infrastructure Fund (AIF), is designed to support financing for eligible agriculture infrastructure and post-harvest management projects. AarambhGrow helps eligible businesses, farmers, FPOs, agri entrepreneurs and other qualifying entities understand the financing requirements and prepare their project and financial documentation.",
            ],
            [
              "Agriculture Infrastructure Financing Support",
              "Agriculture infrastructure financing can support eligible projects involving post-harvest management, storage, processing, logistics, cold-chain infrastructure and community farming assets. Project eligibility, financing terms and applicable benefits depend on the current scheme guidelines, borrower profile, project structure and lending institution.",
            ],
            [
              "NAIFF Loan Eligibility & Project Assessment",
              "Eligibility for agriculture infrastructure finance depends on the applicant category, project activity, infrastructure proposal, project cost, financing requirement and applicable government and lender guidelines. AarambhGrow assists with business assessment, project evaluation, funding requirement analysis and application readiness.",
            ],
            [
              "Agriculture Infrastructure Fund Project Report",
              "A structured project report can present the proposed agriculture infrastructure project, investment requirements, project costs, infrastructure details, revenue assumptions, operating expenses and expected financial performance. Our support focuses on preparing relevant information and documentation for the financing application process.",
            ],
          ].map(([title, text]) => (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 items-start">
          <aside className="lg:col-span-1 bg-white border border-[#E2E8F0] rounded-md p-3 sm:p-4 shadow-[0_2px_10px_rgba(15,23,42,0.03)] lg:sticky lg:top-6">
            <div className="flex items-start gap-3 p-3 rounded-md bg-[#F8FAFC] border border-[#E2E8F0] mb-3">
              <div className={`${iconBoxClass} bg-[#157327]/10`}>
                <WalletCards className="w-4 h-4 text-[#157327]" />
              </div>
              <div>
                <h3 className="text-[11px] sm:text-xs font-bold leading-[1.35] text-[#03254C]">Agriculture Finance Solutions</h3>
              </div>
            </div>
          ...
          <div id="naiff-content" className="lg:col-span-3 scroll-mt-24">
              ...
              >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
                  <motion.div
                    ...
                    initial="hidden"
                    animate="visible"
                    className={`${cardClass} hover:shadow-[0_5px_18px_rgba(15,23,42,0.06)] transition-shadow duration-200`}
                  >
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      <div className={`${iconBoxClass} bg-[#157327]/10`}>
                        <ShieldCheck className="w-4 h-4 text-[#157327]" />
                      </div>
                      <h3 className={headingClass}>Key Benefits</h3>
                    </div>
                  ...
                  >
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      <div className={`${iconBoxClass} bg-[#03254C]/10`}>
                        <Target className="w-4 h-4 text-[#03254C]" />
                      </div>
                      <h3 className={headingClass}>Best Suitable For</h3>
                    </div>
                ...
                <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                  <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                    <div className={`${iconBoxClass} bg-[#03254C]/10`}>
                      <FileText className="w-4 h-4 text-[#03254C]" />
                    </div>
                    <h3 className={headingClass}>What Aarambh Grow Does</h3>
                  </div>
                ...
                {[
                  {
                    condition: Array.isArray(currentService.financeAreas) && currentService.financeAreas.length > 0,
                    title: "Agriculture Finance Areas",
                    icon: <IndianRupee className="w-4 h-4 text-[#F26522]" />,
                    iconBg: "bg-[#F26522]/10",
                    content: (
                      <div className="flex flex-wrap gap-2">
                  ...
                  {
                    condition: Array.isArray(currentService.infrastructureTypes) && currentService.infrastructureTypes.length > 0,
                    title: "Eligible Infrastructure Areas",
                    icon: <WalletCards className="w-4 h-4 text-[#157327]" />,
                    iconBg: "bg-[#157327]/10",
                    content: (
                      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                        {currentService.infrastructureTypes?.map((item, index) => (
                          <div
                            key={`${item}-${index}`}
                  ...
                  {
                    condition: Array.isArray(currentService.eligibleActivities) && currentService.eligibleActivities.length > 0,
                    title: "Eligible Project Activities",
                    icon: <Target className="w-4 h-4 text-[#03254C]" />,
                    iconBg: "bg-[#03254C]/10",
                    content: (
                      <div className="flex flex-wrap gap-2">
                        {currentService.eligibleActivities?.map((item, index) => (
                          <span
                            key={`${item}-${index}`}
                            className="px-2.5 py-1.5 rounded-md bg-[#157327]/5 border border-[#157327]/15 text-[10px] sm:text-[11px] font-semibold text-[#157327]"
                          >
                  ...
                  .map((section) => (
                    <motion.div key={section.title} variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                      <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                        <div className={`${iconBoxClass} ${section.iconBg}`}>{section.icon}</div>
                ...
                {Array.isArray(currentService.documents) && currentService.documents.length > 0 && (
                  <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className={headingClass}>Commonly Required Documents</h3>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2.5">
                ...
                {Array.isArray(currentService.process) && currentService.process.length > 0 && (
                  <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                    <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                      ...
                      <h3 className={headingClass}>Our NAIFF Financing Process</h3>
                    </div>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
                ...
                <motion.div variants={cardVariants} initial="hidden" animate="visible" className={cardClass}>
                  <div className="flex items-center gap-3 pb-3 mb-4 border-b border-[#E2E8F0]">
                    <div className={`${iconBoxClass} bg-[#F26522]/10`}>
                      <Award className="w-4 h-4 text-[#F26522]" />
                    </div>
                    <h3 className={headingClass}>Why Businesses Choose NAIFF Support</h3>
                  </div>
