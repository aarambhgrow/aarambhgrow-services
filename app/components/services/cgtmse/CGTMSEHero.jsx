...
import { ArrowRight, MessageCircle, ShieldCheck, FileText, Landmark } from "lucide-react";
import { motion } from "framer-motion";

const TRUST_POINTS = [
  {
    title: "MSME Credit",
    description: "Funding assessment & fit",
    icon: Landmark,
    color: "text-[#157327]",
    bg: "bg-[#157327]/10",
  },
  {
    ...
    description: "Detailed DPR preparation",
    icon: FileText,
    color: "text-[#F26522]",
    bg: "bg-[#F26522]/10",
  },
  ...
  return (
    <section className="relative min-h-0 w-full overflow-hidden bg-[#EFFFFD] font-sans sm:min-h-[520px] lg:min-h-[460px]">
      ...
      <div className="absolute right-0 top-0 hidden h-full w-[60%] sm:block lg:w-[50%] xl:w-[45%]">
        <Image
          src="/images/CGTMSE.png"
          alt="CGTMSE support for MSME business loans and credit readiness"
          fill
          priority
      ...
      <div className="relative z-10 mx-auto flex min-h-0 w-full max-w-[1340px] flex-col items-center px-5 pt-6 pb-0 sm:min-h-[500px] sm:flex-row sm:px-8 sm:py-12 lg:min-h-[460px] lg:px-12 xl:px-16">
        ...
        >
          ...
          <h1 className="max-w-[680px] text-[24px] font-extrabold leading-[1.15] tracking-[-0.025em] text-[#03254C] sm:text-[36px] lg:text-[38px]">
            Strengthen Your MSME Loan Application With <span className="text-[#157327]">CGTMSE Support</span>
          </h1>
          ...
          {/* Subtitle */}
          <h2 className="mt-2.5 text-[13px] font-bold leading-tight text-[#F26522] sm:mt-3 sm:text-lg">CGTMSE-Linked Business Finance</h2>

          {/* Description */}
          <p className="mt-2 max-w-[620px] text-[11px] leading-[1.45] text-[#475569] sm:mt-3 sm:text-[13px] sm:leading-[1.6] lg:text-[14px]">
            Prepare your MSME for suitable credit facilities with structured support across funding assessment, project reports, financial
            documentation, business information, and CGTMSE-related loan application readiness.
          </p>
          ...
          <div className="mt-4 flex flex-col gap-3 sm:mt-5 sm:flex-row sm:flex-wrap sm:items-center">
            ...
            >
              ...
              <span className="relative">Assess Loan Readiness</span>
